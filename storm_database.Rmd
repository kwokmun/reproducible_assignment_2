...
```{r}
totaldmg <- arrange(summarise(group_by(subdata, evtype), total_damage = sum(totaldmg)), desc(total_damage))
fatalities <- arrange(summarise(group_by(subdata, evtype), fatalities = sum(fatalities)), desc(fatalities))
injuries <- arrange(summarise(group_by(subdata, evtype), injuries = sum(injuries)), desc(injuries))
```
